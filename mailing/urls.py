...
urlpatterns = [
    ...
    path('mailing/', views.MailingListView.as_view(), name='mailing'),
    path('delete/<int:pk>', views.MailingDeleteView.as_view(), name='mailing_delete'),
    path('users_to_mail/', views.MailingUsersCreateView.as_view(), name='users_to_mail'),
    path('update/<int:pk>', views.MailingUpdateView.as_view(), name='update'),
    ...
    path('mailing_report/', views.MailingTryListView.as_view(), name='mailing_report'),
]
