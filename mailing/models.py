...
class MailingSettings(models.Model):
    mailing_status = models.CharField(max_length=2, choices=Status.choices, default=Status.FINISHED,
    ...
    def __str__(self):
        return f'{self.mailing_status}({self.mailing_time_start.strftime("%H:%M")}), {self.mailing_periods}'
...
class MailingTry(models.Model):
    ...
    mailing_try_status = MailingSettings.mailing_status
